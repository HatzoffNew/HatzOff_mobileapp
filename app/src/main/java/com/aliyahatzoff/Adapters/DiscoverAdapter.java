...
public class DiscoverAdapter  extends RecyclerView.Adapter<DiscoverAdapter.VideoGalleryHolder> {
    ...
    public DiscoverAdapter(Context context, List<VideoGallery> videoGalleryList,String vtype, DiscoverAdapter.OnItemClickListener listener) {
    ...
    @NonNull
    @Override
    public DiscoverAdapter.VideoGalleryHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new DiscoverAdapter.VideoGalleryHolder(
    ...
    @Override
    public void onBindViewHolder(@NonNull DiscoverAdapter.VideoGalleryHolder holder, int position) {
