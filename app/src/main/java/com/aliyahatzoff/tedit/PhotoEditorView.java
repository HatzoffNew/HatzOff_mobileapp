    ...
    public class MyViewPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(@NonNull ViewGroup collection, int position) {
            ...
            if (position == 0) {
                ...
                ivBottom.setImageDrawable(getResources().getDrawable(R.drawable.white_ripple));

            } else if (position == 3) {
                viewBG.setVisibility(VISIBLE);
                ivBottom.setImageDrawable(getResources().getDrawable(R.drawable.wow));
                ivBottom.setVisibility(VISIBLE);

            }else if (position == 4) {
                viewBG.setVisibility(VISIBLE);
                ivBottom.setImageDrawable(getResources().getDrawable(R.drawable.track_selector));
                ivBottom.setVisibility(VISIBLE);
