...
public class ColorPickerAdapter extends RecyclerView.Adapter<ColorPickerAdapter.ViewHolder> {
    ...
    public static List<Integer> getDefaultColors(Context context) {
        ...
        colorPickerColors.add(ContextCompat.getColor(context,R.color.voilet));
        ...
        colorPickerColors.add(ContextCompat.getColor(context,R.color.light_sky_blue));
        colorPickerColors.add(ContextCompat.getColor(context,R.color.dark_shine));
        colorPickerColors.add(ContextCompat.getColor(context,R.color.parrot_green));
        colorPickerColors.add(ContextCompat.getColor(context,R.color.p_green));
        colorPickerColors.add(ContextCompat.getColor(context,R.color.dark_yellow));
