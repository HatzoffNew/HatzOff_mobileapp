...
public class Filter_Adapter extends RecyclerView.Adapter<Filter_Adapter.CustomViewHolder> {
    ...
    public Filter_Adapter(Context context, List<FilterType> arrayList, Filter_Adapter.OnItemClickListener listener,Fine select) {
        this.context = context;
        datalist = arrayList;
        this.listener = listener;
         image = BitmapFactory.decodeResource(context.getResources(), R.drawable.img);
         this.select=select;
    }
    ...
    public void onBindViewHolder(final Filter_Adapter.CustomViewHolder holder, final int i) {
        ...
        //System.out.println("ss="+s+"-i"+i+"-"+PreviewVideoActivity.select_postion );
        switch (s){
            case "BRIGHTNESS":
